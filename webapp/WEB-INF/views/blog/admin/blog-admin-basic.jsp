	...
	<div id="wrap">
		...
		<div id="content">
			...
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${authUser.id}/modifyInfo" method="post" enctype="multipart/form-data">
	 		      	<table id="admin-basic">
			      		...
			      		<tr>
			      			<td>&nbsp;</td>
			      			<td><input id="textLogo" type="file" name="mulFile"></td>      			
			      		</tr>           		
			      	</table>
			      	<div id="btnArea">
